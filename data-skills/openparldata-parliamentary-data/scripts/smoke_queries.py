#!/usr/bin/env python3
"""Run cheap live queries through the OpenParlData source adapter."""
...
def _adapter():
    ...
    spec = importlib.util.spec_from_file_location("openparldata_smoke_adapter", path)
...
def main() -> int:
    adapter = _adapter()
    probes = [
        {"name": "Müller", "language": "de", "limit": 2},
        {
            "q": "Klima",
            "language": "de",
            "filters": {"body_key": "CHE"},
            "sort_by": "-begin_date",
            "limit": 2,
        },
    ]
